(function (global) {
  ...
  global.MWMAP._state = {
    ...
    renderedLines: [],
    renderedPolygons: [],
    renderedManualMarkers: [],
    renderedManualRoutes: [],
    renderedSiteSummaryMarkers: [],
    sitesMeta: [],
    // InfoWindow / 리스너
    currentInfoWindow: null,
    mapClickCloseListener: null,
    // 롱프레스 임시 마커
    longPressTempMarker: null,
    // 수동 마커 상태
    isManualMarkerMode: false,
    manualMarkersTemp: [],
    mapClickManualListener: null,
    // 수동 경로 상태
    isManualRouteMode: false,
    manualRoutePointsTemp: [],
    mapClickManualRouteListener: null,
    manualRouteTempLine: null,
    // 사진 모달
    activePhotoSiteId: null,
    activePhotoDocId: null,
